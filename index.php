...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Omnifood is a premium, healthy food delivery service. Sign up today!">
    <meta name="keywords" content="Omnifood, Delivery, Food, Service, HTML, JavaScript, Css">
  ...
  <body>
    ...
    <section class="section-cities" id="cities">
      ...
      <div class="row js--wp-3">
        ...
        <div class="col span-1-of-4 box">
          ...
          <div class="city-feature">
            <i class="ion-social-twitter icon-small"></i>
            <a href="#">@omnifood_sx</a>
          </div>
        </div>

        <div class="col span-1-of-4 box">
          <img src="resources/img/berlin.jpg" alt="San-Francisco image" />
          <h3>Berlin</h3>
          <div class="city-feature">
            <i class="ion-ios-person icon-small"></i>
            2300+ happy eaters
        ...
        <div class="col span-1-of-4 box">
          <img src="resources/img/london.jpg" alt="San-Francisco image" />
          <h3>London</h3>
          <div class="city-feature">
            <i class="ion-ios-person icon-small"></i>
            1200+ happy eaters
    ...
    <footer>
      ...
      <div class="row">
          <p>
            Copyright &copy; 2019 by Omnifoot. All right reserved.
          </p>
        </div>

    </footer>

    <!-- jQuery and jQuery Waypoints plug-in -->
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
    <script src="vendors/js/jquery.waypoints.min.js"></script>

    <!-- These scripts account for issues in older browsers -->
